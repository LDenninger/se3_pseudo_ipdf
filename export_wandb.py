...
EXP_NAMES=["tabletop_3_can_uni_1"]
...
def export_data(variable_names, exp_name):
    ...
    data_frame = wandb_api.run(str(ROTATION_DIR / path)).history()
    export_data = []

    for var in variable_names:
        data = data_frame[var].to_numpy()
...
if __name__=="__main__":
    ...
    if args.model==0:
        ...
        var_names = ["TrainLoss", "Loglikelihood"]
